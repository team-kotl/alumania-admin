...
function validateForm() {
    ...
    const batchfilter = document.querySelector('input[name="batchfilter"]');
    ...
    if (batchfilter.value.length > 0 && batchfilter.value.length < 4) {
...
document.getElementById("jobpostForm").addEventListener("submit", function (e) {
    ...
    const JobCategoryField = document.querySelector(
