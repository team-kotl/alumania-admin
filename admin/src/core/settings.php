        ...
        <main class="main-content">
            <div class="logout">
                <script src="https://unpkg.com/@dotlottie/player-component@2.7.12/dist/dotlottie-player.mjs"
                    type="module"></script>
                <dotlottie-player id="logout-animation"
                    src="https://lottie.host/f7a742ba-808a-4b0c-b29f-ca0d1e985b30/0utrtWPYc3.json"
                ...
                <div class="popup" id="popup-logout">
                    ...
                    <div class="content-logout" onclick="event.stopPropagation()">
                        ...
                        <div class="button-container">
                            ...
                            <form method="POST">
                                <button class="ok-btn" type="submit" name="logout">Logout</button>
                            </form>
                        </div>
                    </div>
                </div>
